...
class Ui_Buscador(object):
    def setupUi(self, Buscador):
        ...
        self.boton_actor.clicked.connect(Buscador._BuscadorPeliculas__abrir_busqueda_por_actor)
        self.info.clicked.connect(Buscador._BuscadorPeliculas__mostrar_info_pelicula)
